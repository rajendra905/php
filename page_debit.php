...
while($r=mysqli_fetch_array($rs))
{
	...
	else
	{
	   ...
	   mysqli_query($con,$q2);
	   $q3="INSERT INTO `bankblance`( `trid`,`admin_id`, `user_id`, `old_blance`, `Payment`,`bstatus`, `new_blance`, `bdate`, `btime`) VALUES ($newid,'$admin','$user_id','$blance','$paymentt','debit','$new_blance','$ddate','$ttime')";
	  		mysqli_query($con,$q3);
	}
mysqli_close($con);
}
...
<body>
<center><br><br><br><form method="post" action="page_debit.php">
