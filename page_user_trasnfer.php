...
$unic=$newid;
$s="SELECT* from account where accountno=$admin &&  accountno=$aa ";
...
while($r=mysqli_fetch_array($rs))
{
	...
	if($b==1)
	{
	   ...
	   mysqli_query($con,$q2);
	   	$q3="INSERT INTO `bankblance`(`trid`,`admin_id`, `user_id`, `old_blance`, `Payment`,`bstatus`, `new_blance`, `bdate`, `btime`) VALUES ($unic,'$admin','$admin','$blance','$bla','debit','$new_blance','$ddate','$ttime')";
	  		mysqli_query($con,$q3);
...
while($rr=mysqli_fetch_array($rss))
{
	...
	else
	{
	   ...
	   $qq2 = "update account set balnce =$nnew_blance where accountno=$aa";
...
<body>
<center><br><br><br><form method="post" action="page_user_trasnfer.php">
		<table cellpadding="10" bgcolor="#3cb">
			<tr><th  colspan="2" align="center">TRANSFER
			<tr>
				<td>Account no.
